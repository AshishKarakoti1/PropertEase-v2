...
const Listing = ({ id, url, location, bedrooms, bathrooms, area, price, category }) => {
    ...
    const handleOnEditClick = (e) => {
        e.stopPropagation();
        setCurrentListing({
            id, url, location, bedrooms, bathrooms, area, price, category
        });
        navigate(`/update/${id}`);
    };
            ...
            <div className="flex-1 p-6 flex flex-col justify-between">
                <div>
                    ...
                    <h2 className="text-3xl font-bold text-gray-900">
                        ...
                        {category !== 'selling' && <span className="text-sm text-gray-400 font-normal"> /mo</span>}
                    </h2>
                </div>
                ...
                <div className="flex gap-8 text-gray-500">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-semibold">{bedrooms} <span className="text-xs font-normal text-gray-400 uppercase">Beds</span></span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Bath size={18} className="text-indigo-400" />
                        <span className="text-sm font-semibold">{bathrooms} <span className="text-xs font-normal text-gray-400 uppercase">Baths</span></span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Maximize size={18} className="text-indigo-400" />
                        <span className="text-sm font-semibold">{area} <span className="text-xs font-normal text-gray-400 uppercase">sq m</span></span>
                    </div>
                </div>
            </div>
